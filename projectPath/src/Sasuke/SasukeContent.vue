...
export default {
  ...
  methods: {
    getNav () {
      this.$http
        .get(
          '/dt/napi/blog/list/by_category/?start=0&include_fields=sender%2Calbum%2Clike_count%2Cmsg&limit=24&cate_key=5017d172705cbe10c0000008&path=&_=1540455406852'
        )
        .then(res => {
